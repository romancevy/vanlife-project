...
createServer({
  ...
  seeds(server) {
    ...
    server.create("van", {
      ...
      imageUrl:
        "https://res.cloudinary.com/dxiwysn1u/image/upload/v1678914008/i24y8ycnt86zw8grceiq.png",
      type: "rugged",
    });
    server.create("van", {
      id: "3",
    ...
    server.create("van", {
      ...
      imageUrl:
        "https://res.cloudinary.com/dxiwysn1u/image/upload/v1678914006/bp5poarhgsq8edhwts8q.png",
      type: "simple",
    });
    server.create("van", {
      id: "5",
      ...
      imageUrl:
        "https://res.cloudinary.com/dxiwysn1u/image/upload/v1678914006/lcyys5hgenbkvkf5wpe2.png",
      type: "luxury",
    });
    server.create("van", {
      id: "6",
